		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">Login Pengurus</h2>
				</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-4">
					<div class="login-wrap p-0">
		      	<form action="sesi/login" method="POST" class="signin-form">
					@csrf
				...
				<div class="form-group d-md-flex">
	            	<div class="w-50">
		            	<a href="/sesi/register" class="form-control btn btn-primary submit px-3 py-3">
						Register
						</a>
					</div>
	            	...
	            	<div class="w-50">
		            	<label class="checkbox-wrap checkbox-primary">Remember Me
								...
								<div class="w-50 text-md-right">
									...
									<a href="/sesi/register" style="color: #fff">Buat Disini</a>
								</div>
	            </div>
	          </form>
		      </div>
