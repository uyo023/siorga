...
<body>
<h1> Selamat Datang  DI Himpunan Mahasiswa Sistem Informasi <b>Universitas Banten Jaya</b> </h1>
</body>
...
@section('title')
	<title>HIMASI | Title</title>
@endsection

@section('container')

 <!-- ======= Hero Section ======= -->
  <div id="hero" class="hero route bg-image" style="background-image: url({{asset('template/assets/img/hero-bg.jpg')}})">
    <div class="overlay-itro"></div>
    <div class="hero-content display-table">
      <div class="table-cell">
        <div class="container">
          <h2 class="hero-title mb-4">Himpunan Mahasiswa Sistem Informasi</h2>
          <p class="display-5 color-d">Universitas Banten Jaya</p>

          <p class="hero-subtitle"><span class="typed" data-typed-items="Designer, Developer, Networking, Analysis"></span></p>
                ...
                <div class="col-md-6">
                  <div class="row">
                    <div class="col-sm-6 col-md-5">
                      <div class="about-img">
                        <img src="{{asset('template/assets/img/profil.png')}}" class="img-fluid rounded b-shadow-a" alt="">
                      </div>
                    </div>
                    <div class="col-sm-6 col-md-7">
                      <div class="about-info">
                        <p><span class="title-s">Name : </span> <span>Nama</span></p>
              ...
              <div class="work-content">
                <div class="row">
                  <div class="col-sm-8">
                    ...
                    <div class="w-more">
                      <span class="w-ctegory badge-info"> Kategori</span> / <span class="w-date">Pembuatan</span>
                      <p>
                        Deskripsi
                      </p>
                    </div>
